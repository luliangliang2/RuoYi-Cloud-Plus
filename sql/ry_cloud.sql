...
(
    id                 NUMBER           not null        comment '主键',
    user_id            NUMBER           not null        comment '用户ID',
    tenant_id          VARCHAR2(20)      default null    comment '租户id',
    auth_id            VARCHAR2(255)     not null        comment '平台+平台唯一id',
    source             VARCHAR2(255)     not null        comment '用户来源',
    open_id            VARCHAR2(255)     default null    comment '平台编号唯一id',
    user_name          VARCHAR2(30)      not null        comment '登录账号',
    nick_name          VARCHAR2(30)      default ''      comment '用户昵称',
    email              VARCHAR2(255)     default ''      comment '用户邮箱',
    avatar             VARCHAR2(500)     default ''      comment '头像地址',
    access_token       VARCHAR2(255)     not null        comment '用户的授权令牌',
    expire_in          INT              default null    comment '用户的授权令牌的有效期，部分平台可能没有',
    refresh_token      VARCHAR2(255)     default null    comment '刷新令牌，部分平台可能没有',
    access_code        VARCHAR2(255)     default null    comment '平台的授权信息，部分平台可能没有',
    union_id           VARCHAR2(255)     default null    comment '用户的 unionid',
    scope              VARCHAR2(255)     default null    comment '授予的权限，部分平台可能没有',
    token_type         VARCHAR2(255)     default null    comment '个别平台的授权信息，部分平台可能没有',
    id_token           VARCHAR2(255)     default null    comment 'id token，部分平台可能没有',
    mac_algorithm      VARCHAR2(255)     default null    comment '小米平台用户的附带属性，部分平台可能没有',
    mac_key            VARCHAR2(255)     default null    comment '小米平台用户的附带属性，部分平台可能没有',
    code               VARCHAR2(255)     default null    comment '用户的授权code，部分平台可能没有',
    oauth_token        VARCHAR2(255)     default null    comment 'Twitter平台用户的附带属性，部分平台可能没有',
    oauth_token_secret VARCHAR2(255)     default null    comment 'Twitter平台用户的附带属性，部分平台可能没有',
    create_dept        NUMBER(20)                       comment '创建部门',
    create_by          NUMBER(20)                       comment '创建者',
    create_time        datetime                         comment '创建时间',
    update_by          NUMBER(20)                       comment '更新者',
...
(
    ...
    tenant_id         VARCHAR2(20)   not null        comment '租户编号',
    contact_user_name VARCHAR2(20)                   comment '联系人',
    contact_phone     VARCHAR2(20)                   comment '联系电话',
    company_name      VARCHAR2(50)                   comment '企业名称',
    license_number    VARCHAR2(30)                   comment '统一社会信用代码',
    address           VARCHAR2(200)                  comment '地址',
    INTro             VARCHAR2(200)                  comment '企业简介',
    "domain"            VARCHAR2(200)                  comment '域名',
    remark            VARCHAR2(200)                  comment '备注',
    package_id        NUMBER(20)                    comment '租户套餐编号',
...
create table sys_tenant_package (
    package_id              NUMBER(20)     not null    comment '租户套餐id',
    package_name            VARCHAR2(20)                comment '套餐名称',
    menu_ids                VARCHAR2(3000)              comment '关联菜单id',
    remark                  VARCHAR2(200)               comment '备注',
...
create table sys_dept (
  dept_id           NUMBER(20)      not null                   comment '部门id',
  tenant_id         VARCHAR2(20)     default '000000'           comment '租户编号',
  parent_id         NUMBER(20)      default 0                  comment '父部门id',
  ancestors         VARCHAR2(500)    default ''                 comment '祖级列表',
  dept_name         VARCHAR2(30)     default ''                 comment '部门名称',
  order_num         INT          default 0                  comment '显示顺序',
  leader            NUMBER(20)      default null               comment '负责人',
  phone             VARCHAR2(11)     default null               comment '联系电话',
  email             VARCHAR2(50)     default null               comment '邮箱',
  status            char(1)         default '0'                comment '部门状态（0正常 1停用）',
  del_flag          char(1)         default '0'                comment '删除标志（0代表存在 2代表删除）',
  create_dept       NUMBER(20)      default null               comment '创建部门',
  create_by         NUMBER(20)      default null               comment '创建者',
  create_time       datetime                                   comment '创建时间',
  update_by         NUMBER(20)      default null               comment '更新者',
  update_time       datetime                                   comment '更新时间',
  primary key (dept_id)
) ;
...
create table sys_user (
  user_id           NUMBER(20)      not null                   comment '用户ID',
  tenant_id         VARCHAR2(20)     default '000000'           comment '租户编号',
  dept_id           NUMBER(20)      default null               comment '部门ID',
  user_name         VARCHAR2(30)     not null                   comment '用户账号',
  nick_name         VARCHAR2(30)     not null                   comment '用户昵称',
  user_type         VARCHAR2(10)     default 'sys_user'         comment '用户类型（sys_user系统用户）',
  email             VARCHAR2(50)     default ''                 comment '用户邮箱',
  phonenumber       VARCHAR2(11)     default ''                 comment '手机号码',
  sex               char(1)         default '0'                comment '用户性别（0男 1女 2未知）',
  avatar            NUMBER(20)                                 comment '头像地址',
  password          VARCHAR2(100)    default ''                 comment '密码',
  status            char(1)         default '0'                comment '帐号状态（0正常 1停用）',
  del_flag          char(1)         default '0'                comment '删除标志（0代表存在 2代表删除）',
  login_ip          VARCHAR2(128)    default ''                 comment '最后登录IP',
...
(
  post_id       NUMBER(20)      not null                   comment '岗位ID',
  tenant_id     VARCHAR2(20)     default '000000'           comment '租户编号',
  post_code     VARCHAR2(64)     not null                   comment '岗位编码',
  post_name     VARCHAR2(50)     not null                   comment '岗位名称',
...
create table sys_role (
  ...
  tenant_id            VARCHAR2(20)     default '000000'           comment '租户编号',
  role_name            VARCHAR2(30)     not null                   comment '角色名称',
  role_key             VARCHAR2(100)    not null                   comment '角色权限字符串',
...
create table sys_menu (
  menu_id           NUMBER(20)      not null                   comment '菜单ID',
  menu_name         VARCHAR2(50)     not null                   comment '菜单名称',
  parent_id         NUMBER(20)      default 0                  comment '父菜单ID',
  order_num         INT          default 0                  comment '显示顺序',
  path              VARCHAR2(200)    default ''                 comment '路由地址',
  component         VARCHAR2(255)    default null               comment '组件路径',
  query_param       VARCHAR2(255)    default null               comment '路由参数',
  is_frame          INT          default 1                  comment '是否为外链（0是 1否）',
  is_cache          INT          default 0                  comment '是否缓存（0缓存 1不缓存）',
  menu_type         char(1)         default ''                 comment '菜单类型（M目录 C菜单 F按钮）',
  visible           char(1)         default 0                  comment '显示状态（0显示 1隐藏）',
  status            char(1)         default 0                  comment '菜单状态（0正常 1停用）',
  perms             VARCHAR2(100)    default null               comment '权限标识',
  icon              VARCHAR2(100)    default '#'                comment '菜单图标',
  create_dept       NUMBER(20)      default null               comment '创建部门',
  create_by         NUMBER(20)      default null               comment '创建者',
  create_time       datetime                                   comment '创建时间',
  update_by         NUMBER(20)      default null               comment '更新者',
  update_time       datetime                                   comment '更新时间',
  remark            VARCHAR2(500)    default ''                 comment '备注',
  primary key (menu_id)
) ;
...
create table sys_oper_log (
  oper_id           NUMBER(20)      not null                   comment '日志主键',
  tenant_id         VARCHAR2(20)     default '000000'           comment '租户编号',
  ...
  cost_time         NUMBER(20)      default 0                  comment '消耗时间',
  primary key (oper_id)
) ;
...
(
  dict_id          NUMBER(20)      not null                   comment '字典主键',
  tenant_id        VARCHAR2(20)     default '000000'           comment '租户编号',
...
(
  dict_code        NUMBER(20)      not null                   comment '字典编码',
  tenant_id        VARCHAR2(20)     default '000000'           comment '租户编号',
...
create table sys_config (
  config_id         NUMBER(20)      not null                   comment '参数主键',
  tenant_id         VARCHAR2(20)     default '000000'           comment '租户编号',
  config_name       VARCHAR2(100)    default ''                 comment '参数名称',
  config_key        VARCHAR2(100)    default ''                 comment '参数键名',
  config_value      VARCHAR2(500)    default ''                 comment '参数键值',
...
create table sys_logininfor (
  info_id        NUMBER(20)     not null                  comment '访问ID',
  tenant_id      VARCHAR2(20)    default '000000'          comment '租户编号',
  user_name      VARCHAR2(50)    default ''                comment '用户账号',
  client_key     VARCHAR2(32)    default ''                comment '客户端',
  device_type    VARCHAR2(32)    default ''                comment '设备类型',
  ipaddr         VARCHAR2(128)   default ''                comment '登录IP地址',
  login_location VARCHAR2(255)   default ''                comment '登录地点',
  browser        VARCHAR2(50)    default ''                comment '浏览器类型',
  os             VARCHAR2(50)    default ''                comment '操作系统',
  status         char(1)        default '0'               comment '登录状态（0成功 1失败）',
  msg            VARCHAR2(255)   default ''                comment '提示消息',
...
create table sys_notice (
  notice_id         NUMBER(20)      not null                   comment '公告ID',
  tenant_id         VARCHAR2(20)     default '000000'           comment '租户编号',
  notice_title      VARCHAR2(50)     not null                   comment '公告标题',
  ...
  update_by         NUMBER(20)      default null               comment '更新者',
  update_time       datetime                                   comment '更新时间',
  remark            VARCHAR2(255)    default null               comment '备注',
...
create table gen_table (
  table_id          NUMBER(20)      not null                   comment '编号',
  data_name         VARCHAR2(200)    default ''                 comment '数据源名称',
  table_name        VARCHAR2(200)    default ''                 comment '表名称',
  table_comment     VARCHAR2(500)    default ''                 comment '表描述',
  sub_table_name    VARCHAR2(64)     default null               comment '关联子表的表名',
  sub_table_fk_name VARCHAR2(64)     default null               comment '子表关联的外键名',
  class_name        VARCHAR2(100)    default ''                 comment '实体类名称',
  tpl_category      VARCHAR2(200)    default 'crud'             comment '使用的模板（crud单表操作 tree树表操作）',
  package_name      VARCHAR2(100)                               comment '生成包路径',
  module_name       VARCHAR2(30)                                comment '生成模块名',
  business_name     VARCHAR2(30)                                comment '生成业务名',
  function_name     VARCHAR2(50)                                comment '生成功能名',
  function_author   VARCHAR2(50)                                comment '生成功能作者',
  gen_type          char(1)         default '0'                comment '生成代码方式（0zip压缩包 1自定义路径）',
  gen_path          VARCHAR2(200)    default '/'                comment '生成路径（不填默认项目路径）',
  options           VARCHAR2(1000)                              comment '其它生成选项',
  create_dept       NUMBER(20)      default null               comment '创建部门',
  create_by         NUMBER(20)      default null               comment '创建者',
  create_time       datetime                                   comment '创建时间',
  update_by         NUMBER(20)      default null               comment '更新者',
...
create table gen_table_column (
  column_id         NUMBER(20)      not null                   comment '编号',
  table_id          NUMBER(20)                                 comment '归属表编号',
  column_name       VARCHAR2(200)                               comment '列名称',
  column_comment    VARCHAR2(500)                               comment '列描述',
  column_type       VARCHAR2(100)                               comment '列类型',
  java_type         VARCHAR2(500)                               comment 'JAVA类型',
  java_field        VARCHAR2(200)                               comment 'JAVA字段名',
  ...
  query_type        VARCHAR2(200)    default 'EQ'               comment '查询方式（等于、不等于、大于、小于、范围）',
  html_type         VARCHAR2(200)                               comment '显示类型（文本框、文本域、下拉框、复选框、单选框、日期控件）',
  dict_type         VARCHAR2(200)    default ''                 comment '字典类型',
  sort              INT                                        comment '排序',
  create_dept       NUMBER(20)      default null               comment '创建部门',
  create_by         NUMBER(20)      default null               comment '创建者',
  create_time       datetime                                   comment '创建时间',
...
create table sys_oss (
  oss_id          NUMBER(20)   not null                   comment '对象存储主键',
  tenant_id       VARCHAR2(20)           default '000000'  comment '租户编号',
  file_name       VARCHAR2(255) not null default ''        comment '文件名',
  original_name   VARCHAR2(255) not null default ''        comment '原名',
  file_suffix     VARCHAR2(10)  not null default ''        comment '文件后缀名',
  url             VARCHAR2(500) not null                   comment 'URL地址',
  create_dept     NUMBER(20)            default null      comment '创建部门',
  create_time     datetime              default null      comment '创建时间',
  create_by       NUMBER(20)            default null      comment '上传人',
  update_time     datetime              default null      comment '更新时间',
  update_by       NUMBER(20)            default null      comment '更新人',
  service         VARCHAR2(20)  not null default 'minio'   comment '服务商',
  primary key (oss_id)
) ;
...
create table sys_oss_config (
  oss_config_id   NUMBER(20)    not null                  comment '主建',
  tenant_id       VARCHAR2(20)             default '000000'comment '租户编号',
  config_key      VARCHAR2(20)   not null  default ''      comment '配置key',
  access_key      VARCHAR2(255)            default ''      comment 'accessKey',
  secret_key      VARCHAR2(255)            default ''      comment '秘钥',
  bucket_name     VARCHAR2(255)            default ''      comment '桶名称',
  prefix          VARCHAR2(255)            default ''      comment '前缀',
  endpoINT        VARCHAR2(255)            default ''      comment '访问站点',
  "domain"          VARCHAR2(255)            default ''      comment '自定义域名',
  is_https        char(1)                 default 'N'     comment '是否https（Y=是,N=否）',
  region          VARCHAR2(255)            default ''      comment '域',
  access_policy   char(1)       not null  default '1'     comment '桶权限类型(0=private 1=public 2=custom)',
  status          char(1)                 default '1'     comment '是否默认（0=是,1=否）',
  ext1            VARCHAR2(255)            default ''      comment '扩展字段',
  create_dept     NUMBER(20)              default null    comment '创建部门',
  create_by       NUMBER(20)              default null    comment '创建者',
  create_time     datetime                default null    comment '创建时间',
  update_by       NUMBER(20)              default null    comment '更新者',
...
(
    branch_id     NUMBER(20)   NOT NULL COMMENT 'branch transaction id',
    xid           VARCHAR2(100) NOT NULL COMMENT 'global transaction id',
    "context"       VARCHAR2(128) NOT NULL COMMENT 'undo_log context,such as serialization',
