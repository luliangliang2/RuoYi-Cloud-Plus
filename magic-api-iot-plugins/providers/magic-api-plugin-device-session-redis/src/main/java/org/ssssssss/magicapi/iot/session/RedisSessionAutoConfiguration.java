...
public class RedisSessionAutoConfiguration {
	...
	@Bean
	ProviderHealthIndicator redisDeviceSessionHealth(StringRedisTemplate redis,
			org.springframework.core.env.Environment environment) {
		return new ProbeProviderHealthIndicator("device-session", "redis", cacheTtl(environment),
			timeout(environment), () -> {
