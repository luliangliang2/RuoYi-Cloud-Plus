...
public final class RegistryDeviceAuthenticator implements DeviceAuthenticator {
    ...
    @Override public String serviceId() { return "registry-device"; }
    ...
    public AuthenticationResult authenticate(DeviceIdentity identity, DeviceCredential credential,
        ...
        if (device.isEmpty()) return new AuthenticationResult(false, "", "Device is not registered");
        ...
        return authenticated
            ? new AuthenticationResult(true, identity.productId() + "/" + identity.deviceId(), "")
