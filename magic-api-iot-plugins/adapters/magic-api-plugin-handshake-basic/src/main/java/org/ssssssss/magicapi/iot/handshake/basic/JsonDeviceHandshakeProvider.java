...
public final class JsonDeviceHandshakeProvider implements DeviceHandshakeProvider {
    ...
    @Override public String serviceId() { return "json-device-v1"; }
    @Override public String ownerPluginId() { return "handshake-basic"; }
    @Override public Set<String> supportedProtocols() { return Set.of("raw"); }
    @Override public HandshakeResult onConnect(HandshakeContext context) { return HandshakeResult.continueWaiting(); }
