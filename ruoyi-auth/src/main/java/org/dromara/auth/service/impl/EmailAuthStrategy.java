...
import org.dromara.auth.domain.model.EmailAuthParams;
...
public class EmailAuthStrategy implements IAuthStrategy<EmailAuthParams> {
    ...
    @Override
    public LoginVo login(EmailAuthParams authParams, RemoteClientVo client) {
        String tenantId = authParams.getTenantId();
        String email = authParams.getEmail();
        String emailCode = authParams.getEmailCode();
