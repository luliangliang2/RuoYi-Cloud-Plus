...
public class SocialAuthStrategy implements IAuthStrategy<SocialAuthParams> {
     ...
     * 登录-第三方授权登录
     *
     * @param authParams 登录信息
     * @param client     客户端信息
     */
    @Override
    public LoginVo login(SocialAuthParams authParams, RemoteClientVo client) {
        ...
        if ("GITEE".equals(authUserData.getSource())) {
            ...
            HttpUtil.createRequest(Method.PUT, "https://gitee.com/api/v5/user/starred/dromara/sdcdi-Vue-Plus")
                .formStr(MapUtil.of("access_token", authUserData.getToken().getAccessToken()))
                .executeAsync();
            HttpUtil.createRequest(Method.PUT, "https://gitee.com/api/v5/user/starred/dromara/sdcdi-Cloud-Plus")
                .formStr(MapUtil.of("access_token", authUserData.getToken().getAccessToken()))
                .executeAsync();
        }
        ...
        if (ObjectUtil.isNotNull(socialVo) && StrUtil.isNotBlank(tenantId)
            && !tenantId.contains(authParams.getTenantId())) {
