  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>Project-Cloud-Plus后台管理系统</h2>
        <p>
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/JavaLionLi/Project-Cloud-Plus')"
            >访问码云</el-button
          >
          <el-button
            size="mini"
            icon="el-icon-s-home"
            plain
            @click="goTarget('https://github.com/JavaLionLi/Project-Cloud-Plus')"
            >访问主页</el-button
          >
          <el-button
            type="primary"
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/JavaLionLi/Project-Cloud-Plus/wikis/pages?sort_id=5303316&doc_id=2056143')"
          >更新日志</el-button
          >
        </p>
      </el-col>
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="https://gitee.com/JavaLionLi/Project-Cloud-Plus"
                target="_blank"
                >https://gitee.com/JavaLionLi/Project-Cloud-Plus</el-link
              >
            </p>
          </div>
        </el-card>
