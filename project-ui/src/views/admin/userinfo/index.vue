  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="用户登录id" prop="userLoginId">
        <el-input
          v-model="queryParams.userLoginId"
      ...
      <el-form-item label="个性签名" prop="personalSignature">
        <el-input
          v-model="queryParams.personalSignature"
          placeholder="请输入个性签名"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['admin:userinfo:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['admin:userinfo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['admin:userinfo:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="userinfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="头像" align="center" prop="headUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="用户登录id" prop="userLoginId">
          <el-input v-model="form.userLoginId" placeholder="请输入用户登录id" />
        </el-form-item>
        <el-form-item label="头像" prop="headUrl">
          <el-input v-model="form.headUrl" placeholder="请输入头像" />
        </el-form-item>
        <el-form-item label="用户昵称" prop="nickName">
...
<script>
import { listUserinfo, getUserinfo, delUserinfo, addUserinfo, updateUserinfo } from "@/api/admin/userinfo";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户详情编号为"' + ids + '"的数据项？').then(() => {
        this.loading = true;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('admin/userinfo/export', {
        ...this.queryParams
