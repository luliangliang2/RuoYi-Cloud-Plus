<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="逻辑删除;0->未删除，1->删除" prop="deleted">
        <el-input
          v-model="queryParams.deleted"
          placeholder="请输入逻辑删除;0->未删除，1->删除"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="逻辑删除;0->未删除，1->删除" prop="deleted">
          <el-input v-model="form.deleted" placeholder="请输入逻辑删除;0->未删除，1->删除" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除人脉职业标签编号为"' + ids + '"的数据项？').then(() => {
        this.loading = true;
        return delLabel(ids);
      }).then(() => {
        this.loading = false;
